        ...
        >
          ...
          <div className="p-1.5">
            <button
              ...
              className="flex w-full cursor-pointer items-center gap-2.5 rounded-xl px-3 py-2.5 text-xs font-medium text-muted-foreground transition-colors hover:bg-primary-soft hover:text-secondary-foreground"
            >
